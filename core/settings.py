...
#         'NAME': 'ghweulcp_qadri',
#         'USER': 'ghweulcp_arshman',
#         'PASSWORD': 'G&4BZLjqI}GS',
#         'HOST': '127.0.0.1',
#         'PORT': '5432',
#     }
# }
...
EMAIL_HOST = 'qadrisons.com.au'
EMAIL_PORT = 465
EMAIL_HOST_USER = 'info@qadrisons.com.au'
EMAIL_HOST_PASSWORD = '5(H#TmkQ]L&9'
EMAIL_USE_TLS = True
...
JAZZMIN_SETTINGS = {
    ...
    'site_title':'Qadri Sons Admin',

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    'site_header':'Qadri Sons Admin',

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Qadri Sons",

    # Logo to use for your site, must be present in static files, used for brand on top left
    "site_logo": "img/logo23.png",
    ...
    "welcome_sign": "Welcome to the Qadri Sons Admin Portal",

    # Copyright on the footer
    "copyright": "Qadri Sons Library Ltd",
    ...
    'order_with_respect_to':['auth','order','order','app.brand','app.category','app.subcategory','app.subsubcategory','app.product','app.stock','app.headerbanner','app.slider','app.offers'],
