...
class List_Stock_Search(generics.ListAPIView):
    search_fields = ['product__title','product__category__title','product__category__category__title','product__category__category__category__title','product__brand__title','=product__category__title','=product__category__category__title','=product__category__category__category__title','=product__brand__title']
